...
apt install -y python3 python-is-python3 || apt install -y python3 >/dev/null 2>&1
}
function Casper3(){
fun_bar() {
    CMD[0]="$1"
...
res8() {
wget https://raw.githubusercontent.com/Rhyuu11/sc2026/main/slowdns/installsl.sh && chmod +x installsl.sh && ./installsl.sh
clear
}
