...
res1() {
wget https://raw.githubusercontent.com/Rhyuu11/sc2026/main/slowdns/rmbl.sh && chmod +x rmbl.sh && ./rmbl.sh
clear
}
res2() {
wget https://raw.githubusercontent.com/Rhyuu11/sc2026/main/slowdns/rmbl1.sh && chmod +x rmbl1.sh && ./rmbl1.sh
clear
}
res3() {
wget https://raw.githubusercontent.com/Rhyuu11/sc2026/main/slowdns/rmbl2.sh && chmod +x rmbl2.sh && ./rmbl2.sh
clear
}
clear
echo -e "$COLOR1╭══════════════════════════════════════════╮${NC}"
...
install -m 0755 -d /etc/apt/keyrings; gpg --dearmor < jcameron-key.asc > /etc/apt/keyrings/jcameron.gpg 2>/dev/null || cp jcameron-key.asc /etc/apt/keyrings/jcameron.gpg
sleep 0.5
...
if [[ $dobot == "1" ]]; then
clear
wget https://raw.githubusercontent.com/Rhyuu11/newsc/main/dobot/install.sh &> /dev/null
chmod +x install.sh
bash install.sh
rm -rf install.sh
fi
