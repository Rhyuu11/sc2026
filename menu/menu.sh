...
MYIP=$(curl -sS ipv4.icanhazip.com)
Isadmin=$(curl -sS https://raw.githubusercontent.com/Rhyuu11/izinsc/main/ip | grep $MYIP | awk '{print $5}')
Exp2=$(curl -sS https://raw.githubusercontent.com/Rhyuu11/izinsc/main/ip | grep $MYIP | awk '{print $3}')
export RED='\033[0;31m'
export GREEN='\033[0;32m'
Name=$(curl -sS https://raw.githubusercontent.com/Rhyuu11/izinsc/main/ip | grep $MYIP | awk '{print $2}')
...
U2=$(curl -sS https://raw.githubusercontent.com/Rhyuu11/izinsc/main/ip | grep $MYIP | awk '{print $2}')
U3=$(curl -sS https://raw.githubusercontent.com/Rhyuu11/izinsc/main/ip | grep $MYIP | awk '{print $3}')
U4=$(curl -sS https://raw.githubusercontent.com/Rhyuu11/izinsc/main/ip | grep $MYIP | awk '{print $4}')
U5=$(curl -sS https://raw.githubusercontent.com/Rhyuu11/izinsc/main/ip | grep $MYIP | awk '{print $5}')
U6=$(curl -sS https://raw.githubusercontent.com/Rhyuu11/izinsc/main/ip | grep $MYIP | awk '{print $6}')
MYIP=$(curl -sS ipv4.icanhazip.com)
...
madmin=$(curl -sS https://raw.githubusercontent.com/Rhyuu11/izinsc/main/ip | grep $MYIP | awk '{print $5}')
checking_sc
cd
...
cd
rm -rf *
wget https://raw.githubusercontent.com/Rhyuu11/sc2026/main/menu/install-up.sh &> /dev/null
